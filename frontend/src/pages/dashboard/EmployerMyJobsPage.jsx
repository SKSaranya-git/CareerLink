  ...
  return (
    <div>
      <div style={{ marginBottom: 12, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <h1 className="dash-title" style={{ marginBottom: 6 }}>My Jobs</h1>
          <p className="dash-muted">Manage your posted job listings.</p>
        </div>
        <Link className="btn" to="/dashboard/post-job">
          Post a Job
        </Link>
      </div>
                  ...
                  <tr key={job._id}>
                    ...
                    <td style={{ textTransform: 'capitalize' }}>
                      {Array.isArray(job.employmentType)
                        ? job.employmentType.join(", ").replace(/-/g, " ")
