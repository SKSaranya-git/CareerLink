  ...
  return (
    <div className="interview-cal">
      <div className="interview-cal-head">
        <div className="interview-cal-head-copy">
          <div className="interview-cal-kicker">Interview calendar</div>
          <div className="interview-cal-title">{monthLabel}</div>
          <div className="dash-muted">Upcoming interviews for this month</div>
        </div>
        <div className="interview-cal-nav">
          <button
            className="btn secondary-btn small-btn"
            type="button"
            onClick={() => onMonthChange(startOfMonthUTC(new Date()))}
          >
            Today
          </button>
          <button
            className="btn secondary-btn small-btn"
            type="button"
            onClick={() => onMonthChange(addMonthsUTC(monthStart, -1))}
          >
            Prev
          </button>
          <button
